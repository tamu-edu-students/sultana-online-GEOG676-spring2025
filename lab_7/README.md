...
arcpy.management.CompositeBands(\[band1, band2, band3, band4], "output\_combined.tif")



\# Hillshade (DEM file is DEM.tif)

arcpy.ddd.HillShade("DEM.tif", "output\_Hillshade.tif", 315, 45, "NO\_SHADOWS", 1)



\# Slope

arcpy.ddd.Slope("DEM.tif", "output\_Slope.tif", "DEGREE", 1)
